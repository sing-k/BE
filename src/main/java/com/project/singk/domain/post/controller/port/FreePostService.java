...
public interface FreePostService {
    ...
    PageResponse<FreePostListResponse> getFreePosts(Long memberId, int offset, int limit, String sort, String filter, String keyword);
    PageResponse<FreePostListResponse> getMyFreePosts(Long memberId, int offset, int limit, String sort, String filter, String keyword);
